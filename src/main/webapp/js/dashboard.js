...
delete_butts.forEach((butt) => {
    butt.addEventListener("click", () => {
        ...
        let type = butt.id
        if (type === "canteen")
            location.href = 'adminServlet?type=deleteCanteen&activeBar=canteen-info&canteenId=' + id + "&canteenPic=" + pic;
        else if (type === "dish")
...
// discussion-search
// document.querySelectorAll("#community-chat-main div.user").forEach((div) => {
//     div.addEventListener("click", () => {
//         let form = div.closest('main').querySelector("form.info-display")
//         let p_tag = form.querySelectorAll("p")
//         let img = form.querySelector("img")
